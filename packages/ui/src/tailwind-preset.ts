...
const divinePreset = {
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        // Fredoka everywhere for Latin; Indic faces fill missing glyphs.
        sans: [
          "var(--font-sans)",
          "var(--font-reader-te)",
          "var(--font-reader-deva)",
          "var(--font-reader-kn)",
          "var(--font-reader-ta)",
          "var(--font-reader-ml)",
          "var(--font-reader-gu)",
        ...
        mono: ["var(--font-mono)"],
        "reader-en": ["var(--font-sans)", "system-ui", "sans-serif"],
        "reader-deva": [
          "var(--font-reader-deva)",
          "var(--font-sans)",
          "serif",
        ],
        "reader-kn": ["var(--font-reader-kn)", "var(--font-sans)", "serif"],
        "reader-te": ["var(--font-reader-te)", "var(--font-sans)", "serif"],
        "reader-ta": ["var(--font-reader-ta)", "var(--font-sans)", "serif"],
        "reader-ml": ["var(--font-reader-ml)", "var(--font-sans)", "serif"],
        "reader-gu": ["var(--font-reader-gu)", "var(--font-sans)", "serif"],
        "reader-or": ["var(--font-reader-or)", "var(--font-sans)", "serif"],
      },
      fontSize: {
